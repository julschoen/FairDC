...
def main(args):
    ...
    channel, im_size, num_classes, class_names, mean, std, dst_train, dst_test, testloader, loader_train_dict, class_map, class_map_inv = get_dataset(args.dataset, args.data_path, args.batch_real, args.subset, args=args, mtt=True)
    ...
    for it in range(0, args.num_experts):
        ...
        for e in range(args.train_epochs):
            ...
            train_loss, train_acc, timestamps = epoch("train", dataloader=trainloader, net=teacher_net, optimizer=teacher_optim,
                                        criterion=criterion, args=args, aug=True, dataset=args.dataset, timestamps=timestamps)
